<%-- 
    Document   : Search
    Created on : Jun 16, 2024, 5:39:54 PM
    Author     : HP
--%>
...
<body>
    ...
    <header class="header">
        <form action="MainController" method="POST"> 
            <div class="text_user">
                <h2 class="title-head">GIAYHANGHIEU.VN ONLY AUTHENTIC - CHUYÊN HÀNG CHÍNH HÃNG</h2>
                <%
    ...
    <main class="product-container"> 
        <%
            List<ProductDTO> productList = (List<ProductDTO>) request.getAttribute("PRODUCT_SEARCH");
